...
public abstract class MethodAccess {
     ...
     * @return the object
     */
    abstract public Object invoke(final Object instance, final int methodIndex, final Object... args);
    ...
    public Object invoke(final Object instance, final String methodName, final Object... args) {
        ...
        log.trace("객체[{}]의 메소드[{}]를 실행합니다. args=[{}]", instance, methodName, args);
    ...
    public static MethodAccess get(final Class type) {
        ...
        try {
            final MethodAccess access = (MethodAccess) accessClass.newInstance();
