...
import org.joda.time.{LocalDateTime, ReadableDuration, ReadablePeriod}

class JodaRichLocalDateTime(val self: LocalDateTime) extends AnyVal with Ordered[LocalDateTime] {
