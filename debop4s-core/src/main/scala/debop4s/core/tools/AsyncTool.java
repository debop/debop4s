...
/**
 * Java 에서 비동기 프로그래밍을 수행할 수 있도록 해주는 Helper class 입니다.
 *
 * @author 배성혁 sunghyouk.bae@gmail.com
 * @since 13. 6. 28. 오후 11:53
 */
@Slf4j
public final class AsyncTool {
     ...
     * @return 후행 작업 결과를 가지는 {@link Future}
     */
    public static <V, R> Future<R> continueTask(final FutureTask<V> prevTask, final Func1<V, R> func) {
    ...
    /**
     * 지정한 결과를 가지는 {@link FutureTask} 를 반환합니다.
     *
     ...
     * @param <T>      입력 인자의 수형
     * @param <R>      수행 결과의 수형
     * @return 수행 결과의 {@link Future}의 컬렉션
     */
    public static <T, R> List<Future<R>> runAsync(final Iterable<T> elements, final Func1<T, R> func) {
     ...
     * 모든 작업이 완료될 때까지 기다립니다.
     *
     * @param tasks {@link FutureTask} 배열
     */
