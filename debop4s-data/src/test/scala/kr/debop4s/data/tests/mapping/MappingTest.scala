...
import kr.debop4s.data.tests.config.HSqlJpaConfiguration
 ...
 */
@ContextConfiguration(classes = Array(classOf[HSqlJpaConfiguration]), loader = classOf[AnnotationConfigContextLoader])
