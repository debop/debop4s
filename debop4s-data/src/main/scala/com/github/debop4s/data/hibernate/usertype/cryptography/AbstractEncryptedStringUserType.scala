package com.github.debop4s.data.hibernate.usertype.cryptography
...
/**
 * com.github.debop4s.data.hibernate.usertype.cryptography.AbstractEncryptedStringUserType 
 *
