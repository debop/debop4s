...
package object timeperiod {
  ...
  implicit def richInt(n: Int): RichInt = new kr.debop4s.timeperiod.RichInt(n)

  implicit def richLong(n: Long): RichLong = new kr.debop4s.timeperiod.RichLong(n)
  ...
  val TDateTime = kr.debop4s.timeperiod.StaticDateTime
  val TDateTimeFormat = kr.debop4s.timeperiod.StaticDateTimeFormat
  val TISODateTimeFormat = kr.debop4s.timeperiod.StaticISODateTimeFormat
  val TDateTimeZone = kr.debop4s.timeperiod.StaticDateTimeZone
  val TDuration = kr.debop4s.timeperiod.StaticDuration
  val TInterval = kr.debop4s.timeperiod.StaticInterval
  val TLocalDate = kr.debop4s.timeperiod.StaticLocalDate
  val TLocalDateTime = kr.debop4s.timeperiod.StaticLocalDateTime
  val TLocalTime = kr.debop4s.timeperiod.StaticLocalTime
  val TPeriod = kr.debop4s.timeperiod.StaticPeriod
  val TPartial = kr.debop4s.timeperiod.StaticPartial
