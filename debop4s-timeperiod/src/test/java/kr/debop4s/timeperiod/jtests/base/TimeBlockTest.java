...
import kr.debop4s.timeperiod.jtests.samples.TimeBlockPeriodRelationTestData;
...
/**
 * kr.hconnect.timeperiod.test.base.TimeBlockTest
 *
 * @author 배성혁 sunghyouk.bae@gmail.com
 * @since 13. 5. 18. 오후 11:22
 */
@Slf4j
public class TimeBlockTest extends TimePeriodTestBase {
    ...
    public void anytimeTest() throws Exception {
        assertThat(TimeBlock.Anytime().getStart()).isEqualTo(MODULE$.MinPeriodTime());
        assertThat(TimeBlock.Anytime().getEnd()).isEqualTo(MODULE$.MaxPeriodTime());
    ...
    public void defaultContructorTest() throws Exception {
        TimeBlock block = TimeBlock.apply();
    ...
    public void momentTest() throws Exception {
        ...
        TimeBlock block = TimeBlock.apply(moment);

        assertThat(block.hasStart()).isTrue();
        assertThat(block.hasEnd()).isTrue();
        assertThat(block.getDuration()).isEqualTo(MODULE$.MinDuration());
    ...
    public void startReadonlyTest() {
        TimeBlock block = TimeBlock.apply(Times.now(), Durations.hours(1, 0, 0, 0), true);
    ...
    public void endReadonlyTest() {
        TimeBlock range = TimeBlock.apply(Times.now(), Durations.hours(1, 0, 0, 0), true);
    ...
    public void durationTest() {
        ...
        Duration delta = Durations.hours(1, 0, 0, 0);
        ...
        block.setDuration(MODULE$.MinDuration());
        assertThat(block.getDuration()).isEqualTo(MODULE$.MinDuration());
    }
