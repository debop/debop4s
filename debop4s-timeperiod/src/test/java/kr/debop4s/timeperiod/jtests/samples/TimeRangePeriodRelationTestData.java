...
import kr.debop4s.timeperiod.ITimeRange;
...
/**
 * kr.hconnect.timeperiod.test.samples.TimeRangePeriodRelationTestData
 *
...
public class TimeRangePeriodRelationTestData implements Serializable {
    ...
    @Getter private final List<ITimePeriod> allPeriods = new ArrayList<>();
