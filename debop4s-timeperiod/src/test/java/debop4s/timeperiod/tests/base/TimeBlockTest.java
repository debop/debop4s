...
import debop4s.timeperiod.TimeBlock;
...
public class TimeBlockTest extends TimePeriodTestBase {
    ...
    public void defaultContructorTest() throws Exception {
        ...
        assertThat(Times.relation(block, TimeBlock.Anytime())).isEqualTo(PeriodRelation.ExactMatch);
    ...
    public void hasInsideTest() {
        ...
        assertThat(testData.reference().hasInside(testData.getBefore())).isFalse();
