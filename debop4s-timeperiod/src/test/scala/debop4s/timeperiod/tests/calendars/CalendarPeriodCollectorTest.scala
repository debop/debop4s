...
import debop4s.timeperiod.calendars.{CalendarPeriodCollector, CalendarPeriodCollectorFilter}
...
import debop4s.timeperiod.{Timepart, HourRangeInDay, DayOfWeek, Month}
