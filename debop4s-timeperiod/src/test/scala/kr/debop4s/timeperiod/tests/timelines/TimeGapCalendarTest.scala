...
import kr.debop4s.timeperiod.tests.samples.SchoolDay
import kr.debop4s.timeperiod.timeline.TimeGapCalculator
import kr.debop4s.timeperiod.timerange.{CalendarTimeRange, DayRangeCollection, MonthRange}
import kr.debop4s.timeperiod.utils.Times._
import kr.debop4s.timeperiod.utils.{Durations, Times}
import kr.debop4s.timeperiod.{TimeCalendar, TimeRange, TimePeriodCollection}
