...
object Debop4sBuild extends Build {
  ...
  val apacheCommonsSeq = Seq(commonsCodec, commonsCollections, commonsIO, commonsPool2, commonsLang3)
  ...
  val customResolvers = Seq(
    ...
    "debop" at "http://dl.bintray.com/debop/maven/",
  ...
  def commonSettings =
    Defaults.defaultSettings ++ Seq(
      ...
      libraryDependencies ++= Seq(
        ...
        jodaTime, jodaConvert, guava, objenesis, findbugs,
        springTest
      ) ++ apacheCommonsSeq ++ testUnits
    )
  ...
  lazy val debop4sCore = Project(
    ...
    settings = commonSettings ++ Seq(
      libraryDependencies ++= Seq(
        commonsCodec, commonsIO, commonsPool2, mail,
