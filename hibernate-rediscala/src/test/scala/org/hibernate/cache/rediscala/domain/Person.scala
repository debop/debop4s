...
import org.hibernate.annotations.{CacheConcurrencyStrategy, Cascade, CascadeType}


@Entity
@org.hibernate.annotations.Cache(region = "person", usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
