package com.github.debop4s.mongo.tests.examples

import com.github.debop4s.core.parallels.Asyncs
import com.github.debop4s.mongo.tests.AbstractMongoTest
