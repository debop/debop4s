...
object CriteriaUtils {
   ...
   * @return the is between criterion
   */
  def getBetween(propertyName: String,
                 lo: AnyRef,
                 hi: AnyRef,
                 includeLo: Boolean,
  ...
  /** 지정된 시각 이전인 경우 */
  def addElapsed(dc: DetachedCriteria,
                 propertyName: String,
                 moment: Date): DetachedCriteria = {
    dc.add(Restrictions.lt(propertyName, moment))
  }

  /** 지정된 시각 이후인 경우 */
  def addFutures(dc: DetachedCriteria,
                 propertyName: String,
                 moment: Date): DetachedCriteria = {
  ...
  def addNullAsFalse(dc: DetachedCriteria,
                     propertyName: String,
                     value: Option[Boolean] = None): DetachedCriteria = {
  ...
  def addNullAsTrue(dc: DetachedCriteria,
                    propertyName: String,
                    value: Option[Boolean] = None): DetachedCriteria = {
    val v = if (value.isEmpty) true else value.get
