...
import debop4s.data.orm.hibernate.spring.AbstractHibernateMySqlReplicationConfiguration;
...
public class MySqlReplicationConfig extends AbstractHibernateMySqlReplicationConfiguration {
    ...
    @Bean
    public SimpleEntityService simpleEntityService() {
        return new SimpleEntityServiceImpl();
    }
}
